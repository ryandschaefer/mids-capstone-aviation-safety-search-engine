...
# Establish a new connection to dynamodb
def connect():
...
async def delete_cache(key: str) -> None:
    ...
    async with connect() as dynamodb:
...
async def get_cache(key: str) -> None | list[schemas.SearchResult]:
...
async def set_cache(key: str, value: list[schemas.SearchResult], ttl_seconds: int = 86400) -> None:
