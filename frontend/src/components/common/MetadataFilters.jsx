...
/**
 * Metadata filters for ASRS search (client-side on current results).
 * Date, location, anomaly type. Apply re-filters the current result set.
 */
            ...
            <Modal open={modalOpen} onClose={() => setModalOpen(false)} aria-labelledby="metadata-filters-modal">
                ...
                >
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                        Narrow results by event date, location, or anomaly type. All filters are combined (AND). Applied client-side to current results.
                    </Typography>

                    <Tooltip title="Filter by event date. Use year (e.g. 2019) or year-month (e.g. 201906)." placement="top">
                    ...
                    <Tooltip title="Filter by type of safety event (e.g. Altitude, Deviation, Runway)." placement="top">
                        <FormControl fullWidth size="small" sx={{ mb: 2 }}>
